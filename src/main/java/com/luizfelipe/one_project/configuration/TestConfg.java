package com.luizfelipe.one_project.configuration;
...
import com.luizfelipe.one_project.entities.Payment;
...
import com.luizfelipe.one_project.repositories.OrderItemRepository;
...
public class TestConfg implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		this.userRepositoy.saveAll(Arrays.asList(u1,u2));
		...
		Payment pay1 = new Payment(null, Instant.parse("2019-06-20T16:53:07Z"), o1);
		o1.setPayment(pay1);
